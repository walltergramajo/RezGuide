<div data-role="page" id="rulesSection">
  <div class="section">
    ...
    <div class="contentNews">
      <div class="row">
        <div class="small-11 small-centered columns">
        	<h3 class="requestsSubHeader">RULES &amp; POLICIES</h3>
        </div>
      </div>
      <div class="rulesContent1">
        <div class="row">
          <dl class="accordion" data-accordion>
            <dd>
              ...
              <div id="panel13" class="content">
                ...
                14.B Possession of a mini keg, or alcohol container larger than 750ml<br> 
                14.C Possession of drinking apparatus, including but not limited to beer funnel, beer bong, beer hat, or beer boot
              </div>
            </dd>
  					<dd>
                ...
                7.B Social gatherings are to be kept at a reasonable level of volume at all times <br> 
                7.C Physically active sports and games are to not to be played in a manner that could cause injury or damage, or disturb others, and are not to be played in Residence common areas
    					</div>
 					  </dd>
        		<dd>
                ...
                6.B Repeated  failure  to  stay  with  guest<br>
                6.C Receiving  three  or  more  guest  policy  warnings  for  any  reason <br> 
                6.D Repeatedly  not  signing  guests  out  after.
    					</div>
  					</dd>
            <dd>
                ...
                9.B Possession of a smoking device used for a legal substance, including but not limited to pipes or hookahs
    					</div>
        		</dd>
          </dl>
        </div>
  ...
  </div><!--Rules and Policies Section End-->
</div>