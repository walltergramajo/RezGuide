<div data-role="page" id="chatFormSection">
    <div class="section">
    	...
    	<div class="contentChat">
    		<div class="row">
        		<div class="small-4 small-centered columns">
       		    	<img id="chatDummy" src="<?php echo base_url(); ?>img/chatDummy.png" alt="chat_dummy"> 
                </div>
       		</div>
        	<div class="row">
            	<div class="small-10 small-centered columns">
                	<h3 class="chatInformation">YOUR INFORMATION</h3>
                </div>
            </div>
            <div class="row">
            	<div class="small-12 columns">
                	<div class="chatSeperator"></div>
                </div>
            </div>
            <div class="row">
            	<div class="small-10 small-centered columns">
                	<div class="chatForm">
                		<form>
                            ...
                            <textarea rows="4" cols="50" placeholder="Inquiry:"></textarea>
                    	</form>
                    </div>
                </div>
            </div>
