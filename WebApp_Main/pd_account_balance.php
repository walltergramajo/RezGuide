    	...
    	<div class="row">
        	<div class="small-5 small-centered columns">
            	<div class="profileNav">
            		<ul class="pagination"> 
                		<li><a href="pd_account_edit_p2.php"><img id="prevArrow" src="img/profilePrevArrow.png" height="20" width="20" alt="previous"></a></li> 
                    	<li><a href="pd_account_edit.php"><img src="img/profilePageIcon.png" height="20" width="20" alt="emptyPage"></a></li> 
                    	<li><a href="pd_account_edit_p2.php"><img src="img/profilePageIcon.png" height="20" width="20" alt="currentPage"></a></li> 
                        <li><a href="pd_account_balance.php"><img src="img/profileCurrentPage.png" height="20" width="20" alt="currentPage"></a></li> 
