...
CREATE TABLE IF NOT EXISTS tbl_contests (
  ...
  contests_whoenter varchar(150) NOT NULL,
...
INSERT INTO tbl_contests (contests_id, contests_title, contests_description, contests_startdate, contests_enddate, contests_location, contests_link, contests_whoenter, contestCat_id) VALUES
...
CREATE TABLE IF NOT EXISTS tbl_events (
  ...
  events_studentprice varchar(50) NOT NULL,
  events_guestprice varchar(50) NOT NULL,
