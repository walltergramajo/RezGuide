...
CREATE TABLE tbl_directory (
  ...
  directory_username varchar(50) NOT NULL,
  directory_password varchar(64) NOT NULL,
...
INSERT INTO tbl_events (events_id, events_title, events_location, events_startdate, events_enddate, events_caldate, events_description, events_moreinfo, events_link, eventsCat_id, events_whocome) VALUES
