...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Edit Upcoming Event</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Edit Upcoming Event</h2>
                </div>
            </div>
        </div>
    </header>
                    ...
                    <div class="locDateTimeInputs">
                        <div class="row">
                            ...
                            <div class="small-9 columns">
                                <input type="text" placeholder="location" value="Oasis">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                        ...
                        <div class="row">
                            ...
                            <div class="small-9 columns">
                                <input type="text" placeholder="time" value="10:15am">
                            </div>
                        </div>
                    </div>
                </div>
                	...
                	<div class="coreInfo">
                        <div class="row">
                            ...
                            <div class="small-10 columns">
                                <input type="text" placeholder="Title" value="Puppy Relaxation Day">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-2 columns">
