...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Add City Locations</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Add City Locations</h2>
                </div>
            </div>
        </div>
    </header>
        ...
        <form id="createUser">
            <div class="row">
                <div class="small-12 columns">
                	<input id="directName" type="text" placeholder="Name of Location">
                </div>
            </div>
            <div class="row">
            	<div class="small-12 columns">
            ...
            <div class="row">
                ...
                <div class="small-10 columns">
                	<input id="email" type="text" placeholder="Address">
                </div>
            </div>
            <div class="row">
                <div class="small-2 columns">
                ...
                <div class="small-10 columns">
                	<input id="name" type="text" placeholder="(XXX) XXX-XXXX">
                </div>
            </div>
             <div class="row">
                <div class="small-2 columns">
                ...
                <div class="small-10 columns">
                	<input id="username" type="text" placeholder="List Items Here">
                </div>
            </div>
            <div class="row">
                <div class="small-2 columns">
                ...
                <div class="small-10 columns">
                	<input id="password" type="text" placeholder="www.locationwebsite.com">
                </div>
            </div>
            <div class="row">
                <div class="small-2 columns">
                ...
                <div class="small-10 columns">
                	<input id="buses" type="text" placeholder="Buses">
                </div>
            </div>
            <div class="row">
            	<div class="small-12 columns">
