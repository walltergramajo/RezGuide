    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Edit News</h2>
                </div>
            </div>
        </div>
    </header>
    <section id="select">
        <div class="row">
            <div class="small-12 columns">
                <h2 id="subTitle">CHOOSE NEWS TO EDIT</h2>
            </div>
        </div>
        ...
        <div class="row">
        	<div class="small-3 columns">
            	<div class="edit">
                    <a href="cms_edit_news_event.html">
                        <img src="../img/edit.png" alt="Edit">
                    </a>
                </div>
            </div>
            <div class="small-6 columns">
            	<p class="users">News 1</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
        ...
        <div class="row">
        	<div class="small-3 columns">
            	<div class="edit">
                    <a href="cms_edit_news_event.php">
                        <img src="../img/edit.png" alt="Edit">
                    </a>
                </div>
            </div>
            <div class="small-6 columns">
            	<p class="users">News 2</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
                	<img class="delete" src="../img/delete.png" alt="Delete">
        ...
        <div class="row">
        	<div class="small-3 columns">
            	<div class="edit">
                    <a href="cms_edit_news_upcoming.php">
                        <img src="../img/edit.png" alt="Edit">
                    </a>
                </div>
            </div>
            <div class="small-6 columns">
            	<p class="users">News 3</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
                	<img class="delete" src="../img/delete.png" alt="Delete">
        ...
        <div class="row">
        	<div class="small-3 columns">
            	<div class="edit">
                    <a href="cms_edit_news_monthly.php">
                        <img src="../img/edit.png" alt="Edit">
                    </a>
                </div>
            </div>
            <div class="small-6 columns">
            	<p class="users">News 4</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
                	<img class="delete" src="../img/delete.png" alt="Delete">
