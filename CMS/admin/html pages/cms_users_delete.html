...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Delete Users</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Users</h2>
                </div>
            </div>
        </div>
    </header>
    <section id="select">
        <div class="row">
            <div class="small-12 columns">
                <h2 id="subTitle">DELETE A USER</h2>
            </div>
        </div>
