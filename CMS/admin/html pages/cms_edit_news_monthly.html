...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Edit Monthly Event</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Edit Monthly Event</h2>
                </div>
            </div>
        </div>
    </header>
                    ...
                    <div class="locDateTimeInputs">
                        <div class="row">
                            ...
                            <div class="small-9 columns">
                                <input type="text" placeholder="location" value="Merlin Lobby">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <input type="text" placeholder="mm/dd/yyyy" value="10/16/2014">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-3 columns">
                            ...
                            <div class="small-9 columns">
                                <input type="text" placeholder="time" value="2:00pm">
                            </div>
                        </div>
                    </div>
                </div>
                	...
                	<div class="coreInfo">
                        <div class="row">
                            ...
                            <div class="small-10 columns">
                                <input type="text" placeholder="Title" value="Decorate Your Own Cupcakes">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-2 columns">
