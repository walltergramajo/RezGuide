...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Edit FSU Contest</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Edit FSU Contest</h2>
                </div>
            </div>
        </div>
    </header>
                ...
                <div class="small-8 columns">
                	<div class="coreInfo">
                        ...
                        <div class="row">
                            ...
                            <div class="small-4 columns">
                            	<input type="text" placeholder="dd/mm/yyyy" value="11/03/2014">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-2 columns">
                            ...
                            <div class="small-10 columns">
                                <input type="text" placeholder="Who Can Enter" value="Open to everyone">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-2 columns">
                            ...
                            <div class="small-10 columns">
                                <input type="text" placeholder="www.contestLink.com" value="www.contestLink.com">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-12 columns">
