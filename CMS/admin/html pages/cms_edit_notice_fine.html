    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Edit Fine</h2>
                </div>
            </div>
        </div>
    </header>
    <section>
    	...
    	<div class="row">
            <!--<div class="small-2 columns">
            	<div id="fineSide" class="hidden">
                	<input id="points" type="text" placeholder="#" value="2">
                    <label id="pointsLabel">POINTS</label>
                </div>
            </div>-->
