...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Edit User In Directory</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h1 id="titleDirectory" class="header">General Information</h1>
            	<h2 id="titleHeader" class="text-right header">Edit Directory</h2>
                </div>
            </div>
        </div>
    </header>
        ...
        <form id="createUser">
            <div class="row">
                <div class="small-12 columns">
                	<input id="directName" type="text" placeholder="First, Last Name" value="John Smith">
                </div>
            </div>
            <div class="row">
            	<div class="small-12 columns">
            ...
            <div class="row">
                ...
                <div class="small-10 columns">
                	<input id="email" type="email" placeholder="Email" value="jsmith@hotmail.com">
                </div>
            </div>
            <div class="row">
                <div class="small-2 columns">
                ...
                <div class="small-10 columns">
                	<input id="name" type="text" placeholder="Room #" value="610">
                </div>
            </div>
             <div class="row">
                <div class="small-2 columns">
                ...
                <div class="small-10 columns">
                	<input id="username" type="text" placeholder="Username" value="jsmith">
                </div>
            </div>
            <div class="row">
                <div class="small-2 columns">
                ...
                <div class="small-10 columns">
                	<input id="password" type="text" placeholder="XXX-XXX-XXXX" value="555-555-5555">
                </div>
            </div>
            <div class="row">
                <div class="small-2 columns">
