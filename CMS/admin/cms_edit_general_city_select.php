...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Select Location</title>
  ...
  <body>
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Edit City Location</h2>
                </div>
            </div>
        </div>
    </header>
    <section id="select">
        <div class="row">
            <div class="small-12 columns">
                <h2 id="subTitle">CHOOSE A LOCATION</h2>
            </div>
        </div>
        ...
        <div class="row">
        	<div class="small-3 columns">
            	<div class="edit">
                    <a href="cms_edit_general_city.php">
                        <img src="../img/edit.png" alt="Edit">
                    </a>
                </div>
            </div>
            <div class="small-6 columns">
            	<p class="users">SilverCity Cinemas</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
        ...
        <div class="row">
            ...
            <div class="small-6 columns">
            	<p class="users">Masonville Mall</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
                	<img class="delete" src="../img/delete.png" alt="Delete">
    ...
    <section id="popup">
    	<div class="row">
        	<div class="small-12 columns">
            	<p id="deleteNot">Are you sure you want to permanently delete *insert location name here*?</p>
            </div>
        </div>
        <div class="row">
        	<div class="small-12 columns">
