...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Select LTC Route</title>
  ...
  <body>
    ...
    <section id="select">
        <div class="row">
            <div class="small-12 columns">
                <h2 id="subTitle">CHOOSE A BUS ROUTE TO EDIT</h2>
            </div>
        </div>
        ...
        <div class="row">
        	<div class="small-3 columns">
            	<div class="edit">
                    <a href="cms_edit_general_information.php">
                        <img src="../img/edit.png" alt="Edit">
                    </a>
                </div>
            </div>
            <div class="small-6 columns">
            	<p class="users">20 - CherryHill</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
        ...
        <div class="row">
            ...
            <div class="small-6 columns">
            	<p class="users">4 - Oxford Street East</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
                	<img class="delete" src="../img/delete.png" alt="Delete">
    ...
    <section id="popup">
    	<div class="row">
        	<div class="small-12 columns">
            	<p id="deleteNot">Are you sure you want to permanently delete bus *insert bus number here*?</p>
            </div>
        </div>
        <div class="row">
        	<div class="small-12 columns">
