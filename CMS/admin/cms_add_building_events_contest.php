...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Add Building Contest</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Add A Building Contest</h2>
                </div>
            </div>
        </div>
    </header>
                    	...
                    	<div id="browseButton" class="small-10 small-push-3 columns">
                        	<div class="small button">
                            	<span>choose image</span>
                        			<input onchange="readURL(this);" id="imageButton" type="file" value="choose image">
                            </div>
                        </div>
                    </div>
                	<div class="row">
