...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Add An Event</title>
  ...
  <body>
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Add An Event</h2>
                </div>
            </div>
        </div>
    </header>
    ...
    <?php if(!empty($message)){echo $message;} ?>
        <form  enctype="multipart/form-data" action="cms_add_news_event.php" method="post" id="newsEvent">
