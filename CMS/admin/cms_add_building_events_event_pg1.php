...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Add Building Event</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Add A Building Event</h2>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="row">
        	<div class="small-5 small-centered columns">
                <ul id="pageNav">
                    ...
                    <li>
                        <a href="cms_add_building_events_event_pg1.php">
                            <img src="../img/selected.png" alt="Page 1">
                        </a>
                    </li>
                    <li>
                        <a href="cms_add_building_events_event_pg2.php">
