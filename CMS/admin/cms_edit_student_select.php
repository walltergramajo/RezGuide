...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Select A Student</title>
  ...
  <body>
    ...
    <section id="select">
        <div class="row">
            <div class="small-12 columns">
                <h2 id="subTitle">CHOOSE A STUDENT TO EDIT</h2>
            </div>
        </div>
    ...
    <section id="popup">
    	<div class="row">
        	<div class="small-12 columns">
            	<p id="deleteNot">Are you sure you want to permanently delete student *insert student name here*?</p>
            </div>
        </div>
        <div class="row">
        	<div class="small-12 columns">
