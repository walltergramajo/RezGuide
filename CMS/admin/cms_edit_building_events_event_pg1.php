...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Edit Building Event</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Edit Building Event</h2>
                </div>
            </div>
        </div>
    </header>
        ...
        <div class="row">
        	<div class="small-5 small-centered columns">
                <ul id="pageNav">
                    ...
                    <li>
                        <a href="cms_edit_building_events_event_pg2.php"> <img src="../img/WA_dotEmpty.png" alt="Page 2">
                        </a>
                    </li>
                    <li>
