...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Select A Notice</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Edit Notice</h2>
                </div>
            </div>
        </div>
    </header>
    <section id="select">
        <div class="row">
            <div class="small-12 columns">
                <h2 id="subTitle">CHOOSE A NOTICE TO EDIT</h2>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="small-6 columns">
            	<p class="buildRoom">building/room</p>
                <p class="catType">student # - type</p>
            </div>
            <div class="small-3 columns">
            	<a href="#">
