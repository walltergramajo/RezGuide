...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Rezguide Building Events Main Menu</title>
    ...
    <header>
    	<div class="row" id="headerRow">
            ...
            <div class="small-9 columns" id="pageTitle">
            	...
            	<h2 id="titleHeader" class="text-right header">Building Events</h2>
                </div>
            </div>
        </div>
    </header>
        	...
        	<div class="row">
            	<div class="menu">
                    <ul class="build-icons">
                        <li>
                            <a class="botAnchor" href="cms_add_building_events_contest.php">
                            	<div class="row">
                                    <div class="small-5 columns">
                                        <img onMouseOver="swapDark('0')" onMouseOut="swapLight('0')" class="botImg" src="../img/cms-contests.png" alt="Contests">
                                    </div>
                        ...
                        <li>
                            <a class="botAnchor" href="cms_add_building_events_event_pg1.php">
                            	<div class="row">
                                    <div class="small-5 columns">
                                        <img onMouseOver="swapDark('1')" onMouseOut="swapLight('1')" class="botImg" src="../img/cms-events.png" alt="Events">
                                    </div>
                                    <div class="small-7 columns">
                        ...
                        <li>
                            <a class="botAnchor" href="cms_add_building_events_programs_pg1.php">
                                <div class="row">
                                	<div class="small-5 columns">
                                        <img onMouseOver="swapDark('2')" onMouseOut="swapLight('2')" class="botImg" src="../img/cms-info.png" alt="Programs">
                                	</div>
                                	<div class="small-7 columns">
