<div id="optionsIcons" class="row">
    <div class="small-8 small-centered columns">
        <div class="small-2 small-push-4 columns option-add">
            <a class="botAnchor" href="<?php echo base_url(); ?>index.php/<?php echo $controller_uri . "/add"; ?>">
        ...
        <div class="small-2 small-pull-4 columns option-edit">
            <a class="botAnchor" href="<?php echo base_url(); ?>index.php/<?php echo $controller_uri . "/edit"; ?>">
