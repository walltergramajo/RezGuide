    	...
    	<div class="small-6 small-centered columns text-center">
        	<div class="row">
            	<div class=" menu">
                    <ul class="menu-icons">
                        <li>
                            <a class="botAnchor" href="<?php echo base_url(); ?>index.php/fsu/fsu_general">
                        ...
                        <li>
                            <a class="botAnchor" href="<?php echo base_url(); ?>index.php/fsu/fsu_contests">
                            <div class="small-4 columns">
                        ...
                        <li>
                            <a class="botAnchor" href="<?php echo base_url(); ?>index.php/fsu/fsu_events">
                            <div class="small-4 columns">
