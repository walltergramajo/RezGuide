                ...
                <div class="small-8 columns">
                	<div class="coreInfo" id="eventpgOne">
                        ...
                        <div class="row">
                            ...
                            <div class="small-10 columns">
                                <input type="text" placeholder="www.eventLink.com" value="www.fsuevent.com">
                            </div>
                        </div>
                        <div class="row">
                            <div class="small-2 columns">
        ...
        <div class="row">
        	<div class="small-5 small-centered columns">
                <ul id="pageNav">
                    ...
                    <li>
                        <a href="cms_edit_fsu_event_pg2.php"> <img src="<?php echo base_url(); ?>img/WA_dotEmpty.png" alt="Page 2">
                        </a>
                    </li>
                    <li>
