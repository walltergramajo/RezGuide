<section id="select">
        ...
        <div class="row">
        	<div class="small-3 columns">
            	<div class="edit">
                    <a href="<?php echo base_url(); ?>index.php/<?php echo $controller_uri; ?>/<?php echo $function_uri; ?>/edit/<?php echo $row->events_id; ?>">
            ...
            <div class="small-3 columns">
            	<a class="del" href="#" data-record="<?php echo $row->events_id; ?>" data-controller="<?php echo $controller_uri; ?>" data-function="<?php echo $function_uri; ?>">
