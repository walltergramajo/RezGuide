...
<section id="select">
        ...
        <div class="row">
        	<div class="small-3 columns">
            	<div class="edit">
                    <a href="<?php echo base_url(); ?>index.php/<?php echo $section; ?>/<?php echo $uri; ?>/edit/<?php echo $row->contests_id; ?>">
            ...
            <div class="small-3 columns">
            	<a class="del" href="#" data-record="<?php echo $row->contests_id; ?>" data-controller="<?php echo $section; ?>" data-function="<?php echo $uri; ?>">
