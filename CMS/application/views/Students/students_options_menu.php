...
<div class="row">
    <div class="small-7 small-centered columns">
            ...
            <div class="small-2 small-pull-2 columns">
                <a class="botAnchor" href="<?php echo base_url(); ?>index.php/edit/students/points">
                    <img onMouseOver="swapDark('3')" onMouseOut="swapLight('3')" class="botImg" src="<?php echo base_url(); ?>img/MA_points.png" alt="Programs">
                    <h3 class="menuHeaders">Points</h3>
                </a>
            </div>
    </div>
</div>