        	...
        	<div class="small-6 small-centered columns" id="classifiedFilters">
            	<div class="row">
                	<div class="small-2 columns">
                    	<a href="<?php echo base_url(); ?>index.php/classifieds"><img src="<?php echo base_url(); ?>img/WA_all.png" alt="All Classifieds"></a>
                    </div>
                    <div class="small-2 columns">
                    	<a href="<?php echo base_url(); ?>index.php/classifieds/sell/books"><img src="<?php echo base_url(); ?>img/WA_book.png" alt="Books"></a>
                    </div>
                    <div class="small-2 columns">
                    	<a href="<?php echo base_url(); ?>index.php/classifieds/sell/clothing"><img src="<?php echo base_url(); ?>img/WA_clothing.png" alt="Clothing"></a>
                    </div>
                    <div class="small-2 columns">
                    	<a href="<?php echo base_url(); ?>index.php/classifieds/sell/furniture"><img src="<?php echo base_url(); ?>img/WA_furniture.png" alt="Furniture"></a>
                    </div>
                    <div class="small-2 columns">
                    	<a href="<?php echo base_url(); ?>index.php/classifieds/sell/electronics"><img src="<?php echo base_url(); ?>img/WA_electronics.png" alt="Electronics"></a>
                    </div>
                    <div class="small-2 columns">
                    	<a href="<?php echo base_url(); ?>index.php/classifieds/sell/other"><img src="<?php echo base_url(); ?>img/WA_other.png" alt="other"></a>
                    </div>
                </div>
            </div>
        </div>
    	...
    	<div class="small-5 small-push-4 columns">
        	<div class="profileNav3">
        		<ul class="pagination">
                	...
                	<li><a href="<?php echo base_url(); ?>index.php/classifieds"><img src="<?php echo base_url(); ?>img/WA_dotFull.png" height="20px" width="20px" alt="currentPage"></a></li>
                    ...
                    <li><a href="<?php echo base_url(); ?>index.php/classifieds/create"><img src="<?php echo base_url(); ?>img/WA_dotEmpty.png" height="20px" width="20px" alt="emptyPage"></a></li>
                	<li><a href="<?php echo base_url(); ?>index.php/classifieds/buy"><img id="nextArrow" src="<?php echo base_url(); ?>img/WA_rArrow.png" height="20px" width="20px" alt="previous"></a></li>
             	</ul>
            </div>
        </div>
    </div>
