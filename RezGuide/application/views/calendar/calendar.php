                ...
                <div id="calendarAccordion">
                    <dl class="accordion" data-accordion>
                        <?php foreach ($events as $row): ?>
                            <dd>
                                <a href="#panel1" class="accordionLink" onClick="highlightLink(this);"><?php echo $row['events_title'] ?><span class="right"><img src="<?php echo base_url(); ?>img/accordionArrowDownHover.png" alt="Click For more Information."></span></a>
