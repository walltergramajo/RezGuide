        ...
        <div class="small-6 small-centered columns">
          	<nav class="row">
          		<div class="small-3 columns">
                	...
                	<img  onMouseOver="swapDark1('0')" onMouseOut="swapLight1('0')" class="botImg1" src="<?php echo base_url(); ?>img/homeIcon.png" alt="Home">
                    <p class="menuText header">Home</p>
                    </a>
                </div>
                <div class="small-3 columns">
                	<a class="botAnchor" href="<?php echo base_url(); ?>index.php/chat">
                	<img onMouseOver="swapDark1('1')" onMouseOut="swapLight1('1')" class="botImg1" src="<?php echo base_url(); ?>img/chatIcon.png" alt="Chat">
                    <p class="menuText header">Chat</p>
                    </a>
                </div>
                <div class="small-3 columns">
                	<a class="botAnchor" href="<?php echo base_url(); ?>index.php/dashboard/account">
                	<img onMouseOver="swapDark1('2')" onMouseOut="swapLight1('2')" class="botImg1" src="<?php echo base_url(); ?>img/settingIcon.png" alt="Settings">
