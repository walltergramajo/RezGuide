    ...
    <div class="row">
        <div class="small-5 small-push-4 columns">
        	<div class="profileNav2">
        		<ul class="pagination"> 
            		<li><a href="<?php echo base_url(); ?>index.php/dashboard/requests"><img id="prevArrow" src="<?php echo base_url(); ?>img/WA_larrow.png" height="20" width="20" alt="previous"></a></li>
                	<li><a href="<?php echo base_url(); ?>index.php/dashboard/requests"><img src="<?php echo base_url(); ?>img/WA_dotEmpty.png" height="20" width="20" alt="currentPage"></a></li>
                	<li><a href="<?php echo base_url(); ?>index.php/dashboard/requests/mediation"><img src="<?php echo base_url(); ?>img/WA_dotFull.png" height="20" width="20" alt="emptyPage"></a></li>
                    <li><a href="<?php echo base_url(); ?>index.php/dashboard/requests/withdraw"><img src="<?php echo base_url(); ?>img/WA_dotEmpty.png" height="20" width="20" alt="emptyPage"></a></li>
                	<li><a href="<?php echo base_url(); ?>index.php/dashboard/requests/withdraw"><img id="nextArrow" src="<?php echo base_url(); ?>img/WA_rArrow.png" height="20" width="20" alt="previous"></a></li>
             	</ul>
            </div>
        </div>
    </div>
