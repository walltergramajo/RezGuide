	...
	<div class="row">
  	<div class="small-5 small-centered columns">
    	<div class="profileNav">
    		<ul class="pagination"> 
      		<li><a href="<?php echo base_url(); ?>index.php/dashboard/account/edit_p2"><img id="prevArrow" src="<?php echo base_url(); ?>img/profilePrevArrow.png" height="20" width="20" alt="previous"></a></li> 
          ...
          <li><a href="<?php echo base_url(); ?>index.php/dashboard/account/edit_p2"><img src="<?php echo base_url(); ?>img/profilePageIcon.png" height="20" width="20" alt="currentPage"></a></li> 
          <li><a href="<?php echo base_url(); ?>index.php/dashboard/account/balance"><img src="<?php echo base_url(); ?>img/profileCurrentPage.png" height="20" width="20" alt="currentPage"></a></li> 
